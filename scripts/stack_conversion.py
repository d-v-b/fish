...
to_convert = ['/nobackup/ahrens/davis/data/raw/20160608/6dpf_cy171xcy221_f1_omr_1_20160608_170933/',
...
def image_conversion(raw_dir, source_format='stack', dest_format='klb'):
    ...
    print('pre-conversion: number of {0} files: {1}'.format(source_format, len(old_source)))
    ...
    print('post-conversion: number of {0} files: {1}'.format(dest_format, len(new_dest)))
    print('post-conversion: number of {0} files: {1}'.format(source_format, len(new_source)))
